...
export const Poperty = (args: IProperty)=>{
    ...
    return (
        <>
          <Button onClick={() => setOpened((o) => !o)} className={`hover:bg-dark-200 rounded-none flex bg-transparent ${opened?'border-0 border-b border-dark-900 border-t-0 bg-dark-500':''} `}>
            <div className='mr-2'>
